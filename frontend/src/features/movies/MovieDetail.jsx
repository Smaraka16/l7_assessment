          ...
          {movie.director_info && (
            <div className="mb-8">
              ...
              >
                ...
                <div
                  className={`w-16 h-16 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center text-white/50 font-bold text-xl ${movie.director_info.image_url ? "hidden" : ""}`}
                >
                ...
                {movie.actors_info.map((actorInfo) => (
                  ...
                  >
                    <div className="w-full aspect-[2/3] rounded-lg bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center mb-3 overflow-hidden relative">
                      ...
                      <div
                        className={`text-white/20 text-3xl font-bold ${actorInfo.person.image_url ? "hidden" : "flex"}`}
                      >

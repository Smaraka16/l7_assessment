...
import { getActor } from "../../api/actorsApi";
...
const ActorDetail = () => {
  ...
  const loadMoreMovies = useCallback(async () => {
    if (loadingMore || !hasMoreMovies || !actor) return;
  ...
  }, [actor, moviesPage, loadingMore, hasMoreMovies, showToast]);
    ...
    return (
      <div className="bg-black min-h-screen text-white flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white/50">Loading actor...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="text-center">
            {errorCode === "NOT_FOUND" ? (
              <>
                ...
                <p className="text-white/50 mb-4">Redirecting to actors...</p>
              </>
            ) : (
              <>
                <h2 className="text-2xl font-bold text-white mb-2">
  ...
  if (!actor) {
    return (
      <div className="bg-black min-h-screen text-white flex items-center justify-center">
        <div className="text-white/50">Actor not found</div>
      </div>
    );
  }
          ...
          <div className="mb-8">
            <div className="flex items-start gap-6 mb-6">
              ...
              <div className="flex-shrink-0">
                ...
                <div
                  className={`w-48 h-48 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center text-white/50 font-bold text-6xl border-4 border-white/20 ${actor.image_url ? "hidden" : ""}`}
                >

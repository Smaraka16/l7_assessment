...
import { fetchActors, setFilters } from "./actorsSlice";
...
const ActorsList = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    dispatch(fetchActors(updatedFilters));
  };
  ...
  useEffect(() => {
    dispatch(fetchActors(localFilters));
  }, [dispatch]);
    ...
    <div className="bg-black min-h-screen text-white">
      ...
      <div className="bg-gradient-to-b from-black via-black/95 to-transparent pb-6 pt-6 px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 tracking-tight">Actors</h1>
      ...
      <div className="px-8 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          {status === "loading" && (
            <div className="flex items-center justify-center py-20">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-white/50">Loading actors...</p>
              </div>
            </div>
          )}
          ...
          {status === "failed" && (
            <div className="flex items-center justify-center py-20">
              <div className="text-center">
                <p className="text-white/50 mb-4">Unable to load actors</p>
                <button
                  onClick={() => {
                    dispatch(fetchActors(localFilters));
                  }}
          ...
          {status === "succeeded" && actors.length === 0 && (
            <div className="flex items-center justify-center py-20">
              <div className="text-center">
                <p className="text-white/50">No actors found</p>
              </div>
            </div>
          )}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                {actors.map((actor) => (
                  ...
                  >
                    ...
                    {/* Image Placeholder */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center ${actor.image_url ? "hidden" : ""}`}
                    >

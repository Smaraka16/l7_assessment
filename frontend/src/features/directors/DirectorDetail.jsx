  ...
  useEffect(() => {
    const fetchDirector = async () => {
      try {
        ...
        if (code === "NOT_FOUND") {
          setTimeout(() => navigate("/directors"), 3000);
        }
      } finally {
        setLoading(false);
      }
          ...
          <div className="mb-8">
            <div className="flex items-start gap-6 mb-6">
              ...
              <div className="flex-shrink-0">
                ...
                <div
                  className={`w-48 h-48 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center text-white/50 font-bold text-6xl border-4 border-white/20 ${director.image_url ? "hidden" : ""}`}
                >
              ...
              <div className="flex-1">
                ...
                {director.date_of_birth && (
                  <div className="text-white/70 mb-4">
                    <span>
                      Born:{" "}
                      {new Date(director.date_of_birth).toLocaleDateString(
                        "en-US",
